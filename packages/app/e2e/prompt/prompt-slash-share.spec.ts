...
const shareDisabled = process.env.FOLONITE_DISABLE_SHARE === "true" || process.env.FOLONITE_DISABLE_SHARE === "1"
...
test("/share and /unshare update session share state", async ({ page, project }) => {
  test.skip(shareDisabled, "Share is disabled in this environment (FOLONITE_DISABLE_SHARE).")
