export const dict = {
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de PawWork",
  ...
  "session.new.title": "Empieza con una tarea",
  "session.new.subtitle": "Elige primero un flujo integrado y luego dile a PawWork lo que necesitas.",
  "session.new.card.document.title": "Procesar documentos",
  "session.new.card.document.description": "Edita, convierte y extrae contenido de Word, Excel, PowerPoint y PDF.",
  "session.new.card.analysis.title": "Analizar datos",
  "session.new.card.analysis.description": "Resume hojas, crea gráficos y responde preguntas a partir de tus archivos.",
  "session.new.card.writing.title": "Empezar a escribir",
  "session.new.card.writing.description": "Redacta correos, informes, planes y textos de trabajo más pulidos.",
