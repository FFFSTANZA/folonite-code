export const dict = {
  ...
  "dialog.provider.foloniteAsh2.tagline": "Next-generation model for complex tasks (2.0)",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Folonite",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Folonite.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "dialog.provider.editKey": "Edit API key",
  "dialog.provider.deleteKey": "Delete API key",
  "dialog.provider.deleteKey.confirm.title": "Delete {{provider}} API key?",
  "dialog.provider.deleteKey.confirm.body":
    "Are you sure you want to delete this API key? You will need to reconnect the provider to use these models again.",

  "provider.connect.opencodeZen.line1":
    "Folonite Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "folonite.ai/zen",
  "provider.connect.foloniteAsh2.description":
    "Folonite Ash 2.0 is a powerful and fast AI model with a huge context window, strong coding and reasoning abilities, and an excellent balance between speed, intelligence, and cost.",
  "provider.connect.foloniteAsh2.tagline": "Next-generation model for complex tasks (2.0)",
  "provider.connect.foloniteAsh2.visit.link": "folonite.in",

  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Folonite.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Folonite.",
  ...
  "prompt.toast.pathRequired.description":
    "Folonite needs the file path to let the agent read this file. Choose it with the attach button instead.",
  ...
  "dialog.plugins.empty": "Plugins configured in folonite.json",
  ...
  "dialog.server.description": "Switch which Folonite server this app connects to.",
  ...
  "toast.update.description": "A new version of Folonite ({{version}}) is now available to install.",
  ...
  "error.page.action.upToDate": "Folonite is up to date.",
  "error.page.action.busy": "Folonite is already checking for updates.",
  ...
  "error.page.report.prefix": "Please report this error to the Folonite team",
  ...
  "error.page.report.confirm.description": "Folonite will prepare a problem report and open the feedback form.",
  ...
  "error.page.report.copiedFallback":
    "Folonite could not prepare the report. The current error details were copied instead.",
  ...
  "error.chain.checkConfig": "Check your config (folonite.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Folonite does not support MCP authentication yet.',
  ...
  "session.new.title": "What do you want to do with Folonite?",
  ...
  "sidebar.gettingStarted.line1": "Folonite includes free models so you can start immediately.",
  ...
  "sidebar.folonite.search": "Search",
  "sidebar.folonite.empty.description": "Open a project to start using the session-first sidebar.",
  "sidebar.folonite.pinned": "Pinned",
  "sidebar.folonite.all": "All sessions",
  "sidebar.folonite.pinSession": "Pin session",
  "sidebar.folonite.unpinSession": "Unpin session",
  "sidebar.folonite.sort.byProject": "Group by project",
  "sidebar.folonite.sort.byTime": "Sort by time",
  "sidebar.folonite.searchHistory": "Use Search for older sessions",
  ...
  "app.name.desktop": "Folonite Desktop",
  ...
  "settings.worktrees.description": "Worktrees Folonite has created or registered. An active session keeps its worktree bound; run ExitWorktree before you can delete it.",
  ...
  "settings.desktop.wsl.description": "Run the Folonite server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Folonite",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Folonite looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Folonite follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Folonite is themed.",
  ...
  "dialog.websearch.body.default.line1": "You don't need a key. Folonite includes a free web search quota.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Folonite launches",
  ...
  "settings.updates.toast.busy.description": "Folonite is already checking for updates.",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Folonite.",
