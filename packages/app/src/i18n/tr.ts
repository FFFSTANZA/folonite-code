...
export const dict = {
  ...
  "session.panel.files": "Dosyalar",
  "session.panel.changes": "Değişiklikler",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı PawWork ekibine bildirin",
  ...
  "session.new.title": "Bir görevle başla",
  "session.new.subtitle": "Önce yerleşik bir akış seç, sonra PawWork'e neye ihtiyacın olduğunu söyle.",
  "session.new.card.document.title": "Belgeleri işle",
  "session.new.card.document.description": "Word, Excel, PowerPoint ve PDF dosyalarını düzenle, dönüştür ve içeriğini çıkar.",
  "session.new.card.analysis.title": "Veriyi analiz et",
  "session.new.card.analysis.description": "Tabloları özetle, grafik oluştur ve dosyalarındaki soruları yanıtla.",
  "session.new.card.writing.title": "Yazmaya başla",
  "session.new.card.writing.description": "E-postaları, raporları, planları ve iş metinlerini daha hızlı hazırla.",
