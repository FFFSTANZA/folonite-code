export const dict = {
  ...
  "session.panel.changes": "Изменения",
  ...
  "session.new.title": "Начните с задачи",
  "session.new.subtitle": "Сначала выберите встроенный сценарий, а затем скажите PawWork, что вам нужно.",
  "session.new.card.document.title": "Обработать документы",
  "session.new.card.document.description": "Редактируйте, конвертируйте и извлекайте данные из Word, Excel, PowerPoint и PDF.",
  "session.new.card.analysis.title": "Анализировать данные",
  "session.new.card.analysis.description": "Сводите таблицы, стройте графики и отвечайте на вопросы по вашим файлам.",
  "session.new.card.writing.title": "Начать писать",
  "session.new.card.writing.description": "Быстрее готовьте письма, отчёты, планы и рабочие тексты.",
