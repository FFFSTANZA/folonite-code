export const dict = {
  ...
  "session.panel.files": "Datoteke",
  "session.panel.changes": "Promjene",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku PawWork timu",
  ...
  "session.new.title": "Počni od zadatka",
  "session.new.subtitle": "Prvo izaberi ugrađeni tok rada, pa reci PawWorku šta ti treba.",
  "session.new.card.document.title": "Obradi dokumente",
  "session.new.card.document.description": "Uredi, konvertuj i izvuci sadržaj iz Word, Excel, PowerPoint i PDF datoteka.",
  "session.new.card.analysis.title": "Analiziraj podatke",
  "session.new.card.analysis.description": "Sažmi tabele, napravi grafikone i odgovori na pitanja iz svojih datoteka.",
  "session.new.card.writing.title": "Počni pisati",
  "session.new.card.writing.description": "Brže sastavi e-mailove, izvještaje, planove i poslovne tekstove.",
