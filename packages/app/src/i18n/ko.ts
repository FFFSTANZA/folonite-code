...
export const dict = {
  ...
  "error.page.report.prefix": "이 오류를 PawWork 팀에 제보해 주세요: ",
  ...
  "session.new.title": "할 일부터 시작하기",
  "session.new.subtitle": "내장 워크플로를 먼저 고른 뒤 PawWork에 원하는 작업을 알려주세요.",
  "session.new.card.document.title": "문서 처리",
  "session.new.card.document.description": "Word, Excel, PowerPoint, PDF 파일을 편집, 변환, 추출합니다.",
  "session.new.card.analysis.title": "데이터 분석",
  "session.new.card.analysis.description": "스프레드시트를 요약하고 차트를 만들며 파일 기반 질문에 답합니다.",
  "session.new.card.writing.title": "글쓰기 시작",
  "session.new.card.writing.description": "이메일, 보고서, 계획안, 업무 문안을 빠르게 다듬습니다.",
