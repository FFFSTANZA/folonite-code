export const dict = {
  ...
  "session.panel.files": "Filer",
  "session.panel.changes": "Ændringer",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til PawWork-teamet",
  ...
  "session.new.title": "Start med en opgave",
  "session.new.subtitle": "Vælg først et indbygget workflow, og fortæl derefter PawWork, hvad du har brug for.",
  "session.new.card.document.title": "Behandl dokumenter",
  "session.new.card.document.description": "Rediger, konverter og udtræk indhold fra Word, Excel, PowerPoint og PDF.",
  "session.new.card.analysis.title": "Analyser data",
  "session.new.card.analysis.description": "Opsummér ark, lav grafer og besvar spørgsmål ud fra dine filer.",
  "session.new.card.writing.title": "Kom i gang med at skrive",
  "session.new.card.writing.description": "Skriv mails, rapporter, planer og skarpere arbejdstekster hurtigere.",
