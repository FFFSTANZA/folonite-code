export const dict = {
  ...
  "error.page.report.prefix": "このエラーをPawWorkチームに報告してください: ",
  ...
  "session.new.title": "やりたいことから始める",
  "session.new.subtitle": "まず組み込みワークフローを選び、そのあと PawWork にやりたいことを伝えてください。",
  "session.new.card.document.title": "書類を処理する",
  "session.new.card.document.description": "Word、Excel、PowerPoint、PDF を編集、変換、抽出します。",
  "session.new.card.analysis.title": "データを分析する",
  "session.new.card.analysis.description": "表を要約し、グラフを作り、ファイルから答えを導きます。",
  "session.new.card.writing.title": "文章を書く",
  "session.new.card.writing.description": "メール、レポート、計画書、業務文面をすばやく整えます。",
