export const dict = {
  ...
  "session.panel.changes": "التغييرات",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق PawWork",
  ...
  "session.new.title": "ابدأ بمهمة",
  "session.new.subtitle": "اختر أولاً سير عمل مدمجاً، ثم أخبر PawWork بما تحتاجه.",
  "session.new.card.document.title": "معالجة المستندات",
  "session.new.card.document.description": "حرر ملفات Word وExcel وPowerPoint وPDF وحولها واستخرج محتواها.",
  "session.new.card.analysis.title": "تحليل البيانات",
  "session.new.card.analysis.description": "لخص الجداول، وأنشئ الرسوم، وأجب عن الأسئلة اعتماداً على ملفاتك.",
  "session.new.card.writing.title": "ابدأ الكتابة",
  "session.new.card.writing.description": "صغ الرسائل والتقارير والخطط والنصوص العملية بشكل أسرع.",
