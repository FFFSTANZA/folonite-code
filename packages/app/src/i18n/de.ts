...
export const dict = {
  ...
  "session.panel.changes": "Änderungen",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem PawWork-Team",
  ...
  "session.new.title": "Mit einer Aufgabe starten",
  "session.new.subtitle": "Wählen Sie zuerst einen eingebauten Ablauf und sagen Sie PawWork dann, was Sie brauchen.",
  "session.new.card.document.title": "Dokumente bearbeiten",
  "session.new.card.document.description": "Bearbeiten, konvertieren und extrahieren Sie Inhalte aus Word, Excel, PowerPoint und PDF.",
  "session.new.card.analysis.title": "Daten analysieren",
  "session.new.card.analysis.description": "Fassen Sie Tabellen zusammen, erstellen Sie Diagramme und beantworten Sie Fragen aus Ihren Dateien.",
  "session.new.card.writing.title": "Mit dem Schreiben beginnen",
  "session.new.card.writing.description": "Verfassen Sie E-Mails, Berichte, Pläne und saubere Arbeitstexte schneller.",
