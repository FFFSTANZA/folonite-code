...
export const dict = {
  ...
  "settings.general.webSearch.chip.personal": "自带 Key",
  "settings.general.webSearch.chip.env": "EXA_API_KEY 已生效",
  "settings.general.webSearch.chip.invalid": "Key 失效",
  "settings.general.webSearch.secondary.failed": "已切换到内置额度，更新 Key 后自动恢复",
  "settings.general.webSearch.secondary.exhausted": "添加 Exa Key 后可以继续使用网页搜索",
  "settings.general.webSearch.action.manage": "管理 Key",
  "dialog.websearch.title.default": "配置网页搜索",
  "dialog.websearch.title.saved": "Exa 网页搜索",
  "dialog.websearch.title.failed": "Exa Key 已失效",
  "dialog.websearch.title.exhausted": "免费额度已用完",
  "dialog.websearch.body.default.line1": "不配置也能用，爪印会自动使用内置免费额度。",
  "dialog.websearch.body.default.line2": "有 Exa 账号？填入 Key 可获得更高搜索额度。",
  "dialog.websearch.body.exhausted.line1": "内置免费额度已用完。",
  "dialog.websearch.body.exhausted.line2": "填入 Exa Key 后可以继续使用网页搜索。",
  "dialog.websearch.body.env": "EXA_API_KEY 环境变量已生效；要使用其它 Key 请清除环境变量后再来此处保存。",
  "dialog.websearch.placeholder": "Exa API key",
  "dialog.websearch.status.bundled": "当前用爪印内置额度",
  "dialog.websearch.status.exhausted": "当前需要 Exa Key 才能继续搜索",
  "dialog.websearch.status.active": "Exa Key 已生效",
  "dialog.websearch.status.failed": "Key 验证失败，请检查后重新填入",
  "dialog.websearch.status.loading": "正在检查网页搜索状态...",
  "dialog.websearch.status.error": "无法读取网页搜索状态。",
  "dialog.websearch.action.save": "保存 Key",
  "dialog.websearch.action.update": "替换 Key",
  "dialog.websearch.action.remove": "移除 Key",
  "dialog.websearch.action.removeShort": "移除",
  "dialog.websearch.action.saveShort": "保存",
  "dialog.websearch.action.retry": "重试",
  "dialog.websearch.help.getKey": "没有 Key？申请 Exa →",
  "toast.websearch.saved.title": "Exa API Key 已保存",
  "toast.websearch.removed.title": "Exa API Key 已移除",
  "toast.websearch.quota.title": "网页搜索额度已用完",
  "toast.websearch.quota.description": "添加 Exa API Key 后可以继续使用网页搜索。",
  "toast.websearch.invalidKey.title": "网页搜索 Key 需要处理",
  "toast.websearch.invalidKey.description": "请更新或移除已保存的 Exa API Key。",
