...
export const dict = {
  ...
  "error.page.known.localState.description":
    "PawWork 在读取这个工作区的本地状态时遇到了问题。这通常不影响你的原始项目文件。",
  ...
  "error.page.report.confirm.description": "PawWork 会准备一份问题报告并打开反馈表单。",
  ...
  "error.page.report.failed": "PawWork 无法准备问题报告。反馈时请使用下面的技术详情。",
  "error.page.report.copiedFallback": "PawWork 无法准备问题报告。已改为复制当前错误详情。",
