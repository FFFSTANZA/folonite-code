...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 Folonite Zen 或 API 密钥连接",
  "dialog.provider.opencode.tagline": "可靠的优化模型",
  "dialog.provider.opencodeGo.tagline": "适合所有人的低成本订阅",
  "dialog.provider.foloniteAsh2.tagline": "处理复杂任务的下一代模型 (2.0)",
  ...
  "dialog.model.unpaid.freeModels.title": "Folonite内置免费模型",
  ...
  "provider.connect.apiKey.description": "输入你的 {{provider}} API 密钥以连接帐户，并在Folonite中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Folonite Zen 为你提供一组精选的可靠优化模型，用于 AI 助手。",
  ...
  "provider.connect.foloniteAsh2.description":
    "Folonite Ash 2.0 是一款强大且快速的 AI 模型，具有巨大的上下文窗口、强大的代码和推理能力，并在速度、智能和成本之间实现了出色的平衡。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在Folonite中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在Folonite中使用 {{provider}} 模型。",
  ...
  "prompt.toast.pathRequired.description": "Folonite需要文件路径，才能让助手读取这个文件。请用附件按钮重新选择。",
  ...
  "dialog.plugins.empty": "在 folonite.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的Folonite服务器。",
  ...
  "toast.update.description": "Folonite有新版本 ({{version}}) 可安装。",
  ...
  "error.page.action.upToDate": "Folonite已是最新版本。",
  "error.page.action.busy": "Folonite正在检查更新。",
  ...
  "error.page.known.localState.description":
    "Folonite在读取这个工作区的本地状态时遇到了问题。这通常不影响你的原始项目文件。",
  ...
  "error.page.report.confirm.description": "Folonite会准备一份问题报告并打开反馈表单。",
  ...
  "error.page.report.failed": "Folonite无法准备问题报告。反馈时请使用下面的技术详情。",
  "error.page.report.copiedFallback": "Folonite无法准备问题报告。已改为复制当前错误详情。",
  ...
  "error.chain.checkConfig": "请检查你的配置 (folonite.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Folonite暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Folonite内置免费模型，你可以立即开始使用。",
  ...
  "sidebar.folonite.search": "搜索",
  "sidebar.folonite.empty.description": "打开一个项目后，即可使用以会话为中心的侧边栏。",
  "sidebar.folonite.pinned": "已置顶",
  "sidebar.folonite.all": "全部会话",
  "sidebar.folonite.pinSession": "置顶会话",
  "sidebar.folonite.unpinSession": "取消置顶",
  "sidebar.folonite.sort.byProject": "按项目分组",
  "sidebar.folonite.sort.byTime": "按时间排序",
  "sidebar.folonite.searchHistory": "搜索历史会话",

  "app.name.desktop": "Folonite",
  ...
  "settings.worktrees.description": "Folonite创建或登记过的工作树。正在使用中的会话会保持绑定，先调用 ExitWorktree 才能删除。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行Folonite服务器。",
  ...
  "dialog.websearch.body.default.line1": "不配置也能用，Folonite会自动使用内置免费额度。",
  ...
  "dialog.websearch.status.bundled": "当前用Folonite内置额度",
