...
export const dict = {
  ...
  "session.panel.changes": "Endringer",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til PawWork-teamet",
  ...
  "session.new.title": "Start med en oppgave",
  "session.new.subtitle": "Velg først en innebygd arbeidsflyt, og fortell deretter PawWork hva du trenger.",
  "session.new.card.document.title": "Behandle dokumenter",
  "session.new.card.document.description": "Rediger, konverter og hent ut innhold fra Word, Excel, PowerPoint og PDF.",
  "session.new.card.analysis.title": "Analyser data",
  "session.new.card.analysis.description": "Oppsummer ark, lag grafer og svar på spørsmål fra filene dine.",
  "session.new.card.writing.title": "Kom i gang med å skrive",
  "session.new.card.writing.description": "Skriv e-poster, rapporter, planer og bedre arbeidstekster raskere.",
