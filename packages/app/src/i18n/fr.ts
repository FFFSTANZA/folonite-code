export const dict = {
  ...
  "session.panel.changes": "Modifications",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe PawWork",
  ...
  "session.new.title": "Commencez par une tâche",
  "session.new.subtitle": "Choisissez d'abord un flux intégré, puis dites à PawWork ce dont vous avez besoin.",
  "session.new.card.document.title": "Traiter des documents",
  "session.new.card.document.description": "Modifiez, convertissez et extrayez du contenu Word, Excel, PowerPoint et PDF.",
  "session.new.card.analysis.title": "Analyser des données",
  "session.new.card.analysis.description": "Résumez des feuilles, créez des graphiques et répondez à partir de vos fichiers.",
  "session.new.card.writing.title": "Commencer à rédiger",
  "session.new.card.writing.description": "Rédigez des e-mails, rapports, plans et textes de travail plus aboutis.",
