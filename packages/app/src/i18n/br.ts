export const dict = {
  ...
  "session.panel.files": "Arquivos",
  "session.panel.changes": "Alterações",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do PawWork",
  ...
  "session.new.title": "Comece com uma tarefa",
  "session.new.subtitle": "Escolha primeiro um fluxo integrado e depois diga ao PawWork o que você precisa.",
  "session.new.card.document.title": "Processar documentos",
  "session.new.card.document.description": "Edite, converta e extraia conteúdo de Word, Excel, PowerPoint e PDF.",
  "session.new.card.analysis.title": "Analisar dados",
  "session.new.card.analysis.description": "Resuma planilhas, crie gráficos e responda perguntas com base nos seus arquivos.",
  "session.new.card.writing.title": "Começar a escrever",
  "session.new.card.writing.description": "Rascunhe e-mails, relatórios, planos e textos de trabalho mais polidos.",
