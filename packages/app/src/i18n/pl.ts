export const dict = {
  ...
  "session.panel.files": "Pliki",
  "session.panel.changes": "Zmiany",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu PawWork",
  ...
  "session.new.title": "Zacznij od zadania",
  "session.new.subtitle": "Najpierw wybierz wbudowany przepływ, a potem powiedz PawWork, czego potrzebujesz.",
  "session.new.card.document.title": "Przetwarzaj dokumenty",
  "session.new.card.document.description": "Edytuj, konwertuj i wyciągaj treści z plików Word, Excel, PowerPoint i PDF.",
  "session.new.card.analysis.title": "Analizuj dane",
  "session.new.card.analysis.description": "Podsumowuj arkusze, twórz wykresy i odpowiadaj na pytania na podstawie plików.",
  "session.new.card.writing.title": "Zacznij pisać",
  "session.new.card.writing.description": "Szybciej twórz maile, raporty, plany i dopracowane teksty do pracy.",
