export const dict = {
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม PawWork",
  ...
  "session.new.title": "เริ่มจากงานหนึ่งอย่าง",
  "session.new.subtitle": "เลือกเวิร์กโฟลว์ที่มีมาให้ก่อน แล้วบอก PawWork ว่าคุณต้องการอะไร",
  "session.new.card.document.title": "จัดการเอกสาร",
  "session.new.card.document.description": "แก้ไข แปลง และดึงข้อมูลจากไฟล์ Word, Excel, PowerPoint และ PDF",
  "session.new.card.analysis.title": "วิเคราะห์ข้อมูล",
  "session.new.card.analysis.description": "สรุปสเปรดชีต สร้างกราฟ และตอบคำถามจากไฟล์ของคุณ",
  "session.new.card.writing.title": "เริ่มเขียน",
  "session.new.card.writing.description": "ร่างอีเมล รายงาน แผนงาน และข้อความงานให้ดีขึ้นได้เร็วขึ้น",
