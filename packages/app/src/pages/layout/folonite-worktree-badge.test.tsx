...
let FoloniteWorktreeBadge: typeof import("./folonite-worktree-badge").FoloniteWorktreeBadge
...
beforeAll(async () => {
  ...
  FoloniteWorktreeBadge = (await import("./folonite-worktree-badge")).FoloniteWorktreeBadge
})
...
describe("FoloniteWorktreeBadge", () => {
  test("shows worktree name and branch in the visible titlebar label", () => {
    const onClick = () => undefined
    const tree = FoloniteWorktreeBadge({
      name: "feature-c",
      branch: "folonite/feature-c",
      directory: "/repo/.worktrees/folonite/feature-c",
    ...
    expect(label?.children.join("")).toBe("feature-c (folonite/feature-c)")
    expect(tree.props.title).toBe("folonite/feature-c · /repo/.worktrees/folonite/feature-c")
