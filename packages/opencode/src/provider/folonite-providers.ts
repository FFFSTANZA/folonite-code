...
export const FOLONITE_PROVIDER_OVERLAYS: Record<string, ModelsDev.Provider> = {
  [VOLCENGINE_PLAN_PROVIDER_ID]: {
  ...
  "folonite-ash-2": {
    ...
    env: ["FOLONITE_ASH_API_KEY"],

    models: {
      "gemini-2.5-flash": textModel("gemini-2.5-flash", "Folonite Ash 2.0", 1000000, 8192, {
        attachment: true,
...
export function withFoloniteProviders(providers: Record<string, ModelsDev.Provider>) {
  return {
    ...providers,
    ...FOLONITE_PROVIDER_OVERLAYS,
  }
}
