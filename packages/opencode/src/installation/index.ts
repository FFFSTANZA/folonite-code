...
export namespace Installation {
  ...
  export const USER_AGENT = `folonite/${CHANNEL}/${VERSION}/${Flag.FOLONITE_CLIENT}`
  ...
  export class Service extends Context.Service<Service, Interface>()("@folonite/Installation") {}
